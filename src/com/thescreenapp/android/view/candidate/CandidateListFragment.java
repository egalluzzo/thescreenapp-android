...
//	}
	...
	public Loader<Query<Candidate>> onCreateLoader(int id, Bundle args) {
		return new QueryLoader<Candidate>(getActivity(), new QueryCreator<Candidate>() {
	...
	@Override
	public void onLoadFinished(Loader<Query<Candidate>> loader, Query<Candidate> query) {
	...
	public void bindView(View view, Candidate candidate) {
		((TextView) view.findViewById(android.R.id.text1)).setText(candidate.getFirstName());
	}
}
